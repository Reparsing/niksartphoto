        ...
        (function() {
            ...
            for (let i = 0; i < 15; i++) {
                ...
                emoji.style.cssText = `
                    ...
                    top: ${Math.random() * 100}%;
                    animation: floatEmoji ${Math.random() * 20 + 15}s ease-in-out infinite;
            ...
            style.textContent = `
                @keyframes floatEmoji {
                    ...
                    25% {
                        transform: translate(${Math.random() * 60 - 30}px, ${Math.random() * 60 - 30}px) rotate(${Math.random() * 60}deg) scale(1.1);
                    }
                    50% {
                        transform: translate(${Math.random() * 60 - 30}px, ${Math.random() * 60 - 30}px) rotate(${Math.random() * -60}deg) scale(0.9);
                    }
                    75% {
                        transform: translate(${Math.random() * 60 - 30}px, ${Math.random() * 60 - 30}px) rotate(${Math.random() * 30}deg) scale(1.05);
                    }
                    100% {
                        transform: translate(0, 0) rotate(0deg) scale(1);
                    }
